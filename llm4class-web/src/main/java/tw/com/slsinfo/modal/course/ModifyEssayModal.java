...
public class ModifyEssayModal extends BaseModal<EssayViewModel> {
    private static final Logger logger = LogManager.getLogger(ModifyEssayModal.class);
    ...
    private Integer sid;
    private GenreDropDownChoice genreDropDownChoice;
    ...
    public ModifyEssayModal(String id, Integer sid) {
        super(id);
        this.sid = sid;
        init();
    }
    ...
    private void init() {
        ...
        //傳入sid
        genreDropDownChoice = new GenreDropDownChoice("genreobject", sid);
        ...
        formModal.add(title, genreDropDownChoice, enableViewDropDownChoice, supplementarytxt);
    ...
    public void setModelObject(EssayViewModel essayViewModel) {
        this.model = essayViewModel;
        formModal.setDefaultModel(new CompoundPropertyModel<>(model));
        enableViewDropDownChoice.modelChanged();
        genreDropDownChoice.setModelObjectFromView(essayViewModel.getGenreobject());
    }
