...
- **GIVEN** stored Step10 text uses legacy escaped line breaks, double-escaped line breaks, JSON string/object wrappers, nested LLM provider response wrappers, content array/text wrappers, markdown marker HTML entities, or an outer markdown code fence
